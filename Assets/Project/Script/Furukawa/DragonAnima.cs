...
public class DragonAnima : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (normalTime >= TentaTime&&tent)
        {
            ...
            AudioManager.manager.PlayPoint(AudioManager.manager.data.seki1, gameObject, 2.0f);
        ...
        if (normalTime >= MushTime&&mush)
        {
            ...
            AudioManager.manager.PlayPoint(AudioManager.manager.data.seki2, gameObject, 2.0f);
            mush = false;
        }
    }
    ...
    public void PlayHelp()=>
        AudioManager.manager.PlayPoint(AudioManager.manager.data.help, gameObject, 2.0f);
}
